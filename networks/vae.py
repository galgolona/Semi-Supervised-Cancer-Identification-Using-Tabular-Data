...
class Decoder(nn.Module):
    ...
    def __init__(self, dims):
        ...
        self.hidden = nn.ModuleList(linear_layers) # gal: hidden layer to condition on previous data points rnn
...
class VariationalAutoencoder(nn.Module):
    ...
    def _kld(self, z, q_param, p_param=None):
        ...
        """
        (mu, log_var) = q_param
        print('in var file in kld function uses entrpty and gaussian shit')
